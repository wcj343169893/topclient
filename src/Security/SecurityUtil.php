...
class SecurityUtil
{
    ...
    function encryptPhone($data, $separator, $secretContext)
    {
        ...
        return $separator . $prefixNumber . $separator . Security::encrypt($last8Number, $secretContext->secret) . $separator . $secretContext->secretVersion . $separator;
    }
    ...
    function encryptPhoneIndex($data, $separator, $secretContext)
    {
        ...
        return $separator . $this->hmacMD5EncryptToBase64($last4Number, $secretContext->secret) . $separator . Security::encrypt($data, $secretContext->secret) . $separator . $secretContext->secretVersion . $separator . $separator;
    }
    ...
    function encryptNormalIndex($data, $compressLen, $slideSize, $separator, $secretContext)
    {
        ...
        return $separator . Security::encrypt($data, $secretContext->secret) . $separator . $builder . $separator . $secretContext->secretVersion . $separator . $separator;
    }
